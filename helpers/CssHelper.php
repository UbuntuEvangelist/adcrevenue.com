...
class CssHelper
{
	...
	/**
     * Returns the appropriate css class based on the value of user $status.
     * NOTE: used in monitoringchok/index view.
     *
     * @param  string $status Monitoringchok status.
     * @return string         Css class.
     */
    public static function monitoringchokStatusCss($status)
    {
        if ($status !== Monitoringchok::STATUS_FINISHED) {
            return "boolean-false";
        }
